...
const Code = (props: SvgProps) => (
    <AccessibleSVG width={32} height={32} viewBox="0 0 32 32" {...props}>
        <g fill="none">
            ...
            <path
                fill="#FFF"
                d="M17.553 13.776a.5.5 0 01.894.448l-4 8a.5.5 0 01-.894-.448zm-4.83 1.808a.5.5 0 01.554.832L10.901 18l2.376 1.584a.5.5 0 01-.554.832l-3-2a.5.5 0 010-.832zm6.554 0l3 2a.5.5 0 010 .832l-3 2a.5.5 0 01-.554-.832L21.099 18l-2.376-1.584a.5.5 0 01.554-.832z"
            />
        </g>
    </AccessibleSVG>
);
